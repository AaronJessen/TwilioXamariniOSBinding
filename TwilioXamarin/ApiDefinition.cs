...
namespace TwilioXamarin
{
	...
	interface TVIAudioOptionsBuilder
	{
		...
		// @property (assign, nonatomic) int levelControlInitialPeakLevelDBFS;
		[Export("levelControlInitialPeakLevelDBFS")]
		int LevelControlInitialPeakLevelDBFS { get; set; }
	}
	...
	interface TVIAudioOptions
	{
		...
		// @property (readonly, assign, nonatomic) int levelControlInitialPeakLevelDBFS;
		[Export("levelControlInitialPeakLevelDBFS")]
		int LevelControlInitialPeakLevelDBFS { get; }
	...
	{
        // todo wrapper for CMSampleBufferRef
		// @required -(void)renderSample:(CMSampleBufferRef)audioSample;
		[Abstract]
		[Export("renderSample:")]
        void RenderSample(IntPtr audioSample);
	}
	...
	{
		// todo wrapper for CVImageBufferRef
        ...
        IntPtr Constructor(long timestamp, IntPtr imageBuffer, TVIVideoOrientation orientation);
	...
	interface TVIRoomDelegate
	{
        ...
        // todo wrapper method for 2 functions with same parameters
	...
	interface TVILocalVideoTrack
	{
		...
		[return: NullAllowed]
		TVILocalVideoTrack TrackWithCapturer(TVIVideoCapturer capturer, bool enabled, [NullAllowed] TVIVideoConstraints constraints);
	}
